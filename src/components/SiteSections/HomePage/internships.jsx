...
class Internships extends Component {
    ...
    render() {
        return (
            <React.Fragment >
                <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 ardentGrey" id="internships" style={{ backgroundColor: '#efefef', width: "105%", position: "relative", left: "-15px" }}>
