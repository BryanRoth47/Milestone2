...
class WhatWeDo extends Component {
    ...
    render() {
        return (
            <React.Fragment >
                <div className="position-relative overflow-hidden p-3 p-md-5 m-md-3 bg-light" id="whatWeDo" style={{width:"100%", position:"relative", left:"-15px"}}>

                    <div className="container" style={{position:"relative", left:"65px"}}>
                        <div className="row">
                            <div className="col">
                                <h1 className="sectionHeading font88 ardentGrey">WHAT WE DO</h1>
                            </div>
                        </div>
                        <div className="row " style={{color: '#CCCCCA', marginBottom:'50px' }}>
                            <h1 className="col font260" style={{fontWeight:'lighter', lineHeight:'80%'}}>01</h1>
                            <h1 className="col font260" style={{fontWeight:'lighter', lineHeight:'80%'}}>02</h1>
                            <h1 className="col font260" style={{fontWeight:'lighter', lineHeight:'80%'}}>03</h1>
                        </div>
                        <div className="row" style={{ stroke: 'rgb(0,0,0)', strokeWidth: "4" }}>
                            <div className="col">
                        ...
                        <div className="row">
                            <div className="col">
                                <h3 className="ardentBlue" style={{margin:"20px 0px"}}>BUILD</h3>
                            ...
                            <div className="col">
                                <h3 className="ardentBlue" style={{margin:"20px 0px"}}>TRAIN</h3>
                            ...
                            <div className="col">
                                <h3 className="ardentBlue" style={{margin:"20px 0px"}}>INCUBATE</h3>
