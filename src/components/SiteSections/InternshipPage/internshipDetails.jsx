        ...
        return (
            <React.Fragment>
                <div className="position-relative overflow-hidden p-3 p-md-5 m-md-3 white justify-center">
                    ...
                    <div className="row white" style={{ paddingLeft: '50px', marginTop: "50px" }}>
                    ...
                    <div className="row white" style={{ paddingLeft: '50px', marginTop: "50px" }}>
                        ...
                        <div className="white">
                            <p className="font_8" style={{ lineHeight: "1.2em" }}>
                                    ...
                                    <span className="color_11">
                                        ...
                                        <span style={{ textDecoration: "underline" }}>,</span>
                                            ...
                                            <span style={{ textDecoration: "underline" }}>
                                                <a href="https://ead60fcc-40f3-4b04-9c66-485499008c9a.filesusr.com/ugd/132a22_10acddd2d98747ed97eae09cef4f048e.pdf" target="_blank" rel="noopener noreferrer" data-type="document" className='white'>click here</a>
                                            </span>.
                                        </span>
                                    </span>
                                </span>
